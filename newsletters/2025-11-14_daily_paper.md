...
# <img src="https://huggingface.co/datasets/huggingface/brand-assets/resolve/main/hf-logo.png" width="30"/> Hugging Face 2025-11-14 论文日报

## 📊 今日论文统计
- 总论文数：18
- 热门领域：GPT, LLM, Transformer, Audio

## 📝 论文详情


### 1. 潜在空间一小步，像素生成大飞跃：面向扩散模型的快速潜在上采样适配器

**原文标题：** One Small Step in Latent, One Giant Leap for Pixels: Fast Latent Upscale Adapter for Your Diffusion Models
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.10629) | [arXiv](https://arxiv.org/abs/2511.10629)



---

### 2. PAN：一种通用、可交互且长时域的世界仿真世界模型

**原文标题：** PAN: A World Model for General, Interactable, and Long-Horizon World Simulation
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.09057) | [arXiv](https://arxiv.org/abs/2511.09057)



---

### 3. UniVA：面向开源的新一代视频通用智能体的通用视频智能体框架

**原文标题：** UniVA: Universal Video Agent towards Open-Source Next-Generation Video Generalist
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.08521) | [arXiv](https://arxiv.org/abs/2511.08521)
...
**原文标题：** Black-Box On-Policy Distillation of Large Language Models

**摘要：**
黑盒蒸馏技术仅通过习得专有教师模型的文本输出即可创建学生大语言模型，而无需访问其内部逻辑值或参数。本研究提出生成对抗蒸馏方法，实现了同策略的黑盒蒸馏。该方法将学生大语言模型构建为生成器，并训练判别器来区分其响应与教师大语言模型的响应，从而形成极小极大博弈框架。该判别器作为与学生模型协同演进的同策略奖励模型，可提供稳定自适应的反馈机制。实验结果表明，生成对抗蒸馏方法持续优于常用的序列级知识蒸馏。特别值得注意的是，采用该方法训练的Qwen2.5-14B-Instruct（学生模型）在LMSYS-Chat自动评估中达到了与教师模型GPT-5-Chat相当的性能。这些研究成果确立了生成对抗蒸馏作为黑盒大语言模型蒸馏领域具有前景且有效的范式。

**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.10643) | [arXiv](https://arxiv.org/abs/2511.10643)



---

### 5. 致敬窃贼：探索去中心化GRPO中的攻击与防御策略

**原文标题：** Hail to the Thief: Exploring Attacks and Defenses in Decentralised GRPO
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.09780) | [arXiv](https://arxiv.org/abs/2511.09780)



---

### 6. Depth Anything 3：从任意视角重建视觉空间
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.10647) | [arXiv](https://arxiv.org/abs/2511.10647)



---

### 7. 叠加梯度下降法：运用量子原理优化模型训练

**原文标题：** Superpositional Gradient Descent: Harnessing Quantum Principles for
  Model Training

**摘要：**
当前大规模语言模型普遍采用AdamW等经典优化技术进行训练以提升收敛性与泛化能力，然而量子启发性方法增强经典训练的内在机制仍待深入探索。本文提出叠加梯度下降法——一种通过注入量子电路扰动将梯度更新与量子叠加态相关联的新型优化器。我们建立了完整的数学框架，并在PyTorch和Qiskit平台上实现了混合量子-经典电路。在合成序列分类任务和大规模语言模型微调实验中，该方法相较AdamW实现了更快的收敛速度与更低的最终损失值。尽管取得积极成果，可扩展性与硬件限制仍是实际应用的瓶颈。本研究为量子计算与深度学习的交叉领域提供了新见解，指出了利用量子原理调控模型行为的可行路径。

**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.01918) | [arXiv](https://arxiv.org/abs/2511.01918)



---

### 8. 零误差完成百万步大语言模型任务的实现方案
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.09030) | [arXiv](https://arxiv.org/abs/2511.09030)



---

### 9. AlphaResearch：利用语言模型加速新算法发现的探索

**原文标题：** AlphaResearch: Accelerating New Algorithm Discovery with Language Models
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.08522) | [arXiv](https://arxiv.org/abs/2511.08522)



---

### 10. Music Flamingo：音频语言模型中音乐理解能力的规模化拓展

**原文标题：** Music Flamingo: Scaling Music Understanding in Audio Language Models
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.10289) | [arXiv](https://arxiv.org/abs/2511.10289)



---

### 11. 基于量规的基准测试与强化学习在提升大语言模型指令遵循能力中的应用

**原文标题：** Rubric-Based Benchmarking and Reinforcement Learning for Advancing LLM Instruction Following
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.10507) | [arXiv](https://arxiv.org/abs/2511.10507)



---

### 12. 基于属性条件人工评估的图像生成多样性基准测试

**原文标题：** Benchmarking Diversity in Image Generation via Attribute-Conditional Human Evaluation
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.10547) | [arXiv](https://arxiv.org/abs/2511.10547)



---

### 13. ResearchRubrics：深度研究智能体评估的提示与评分标准基准
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.07685) | [arXiv](https://arxiv.org/abs/2511.07685)



---

### 14. MuSc-V2：基于无标签样本互评的零样本多模态工业异常分类与分割方法

**原文标题：** MuSc-V2: Zero-Shot Multimodal Industrial Anomaly Classification and Segmentation with Mutual Scoring of Unlabeled Samples
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.10047) | [arXiv](https://arxiv.org/abs/2511.10047)



---

### 15. AffordBot：基于多模态大语言模型的3D细粒度具身推理

**原文标题：** AffordBot: 3D Fine-grained Embodied Reasoning via Multimodal Large Language Models
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.10017) | [arXiv](https://arxiv.org/abs/2511.10017)



---

### 16. SliderEdit：基于细粒度指令控制的连续图像编辑

**原文标题：** SliderEdit: Continuous Image Editing with Fine-Grained Instruction Control
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.09715) | [arXiv](https://arxiv.org/abs/2511.09715)



---

### 17. MM-CRITIC：大型多模态模型多维度批判能力的系统性评估

**原文标题：** MM-CRITIC: A Holistic Evaluation of Large Multimodal Models as Multimodal Critique

**摘要：**
批判能力对模型实现自我提升及成为可靠AI助手至关重要。尽管在纯语言环境中已得到广泛研究，但大型多模态模型的批判能力——尽管其在图像描述、视觉推理等任务中表现日益增强——仍缺乏系统性探索。本研究提出MM-CRITIC评估框架，从基础批判、修正批判与比较批判三个维度系统评估LMMs的批判能力。该基准覆盖8类主要任务逾500个子任务，收集了不同参数规模LMMs的响应数据，共构成4471个评估样本。为提升评估信度，我们融合专家知识构建标准答案评分体系，指导GPT-4o完成响应标注并生成基准批判意见，为可信评估提供锚点。大规模实验验证了MM-CRITIC的有效性，并对主流LMMs的批判能力进行了多维度全景评估。深度分析揭示了若干关键发现：包括模型响应质量与批判能力的关联性，以及不同评估维度间批判难度的差异性。代码已开源：https://github.com/MichealZeng0420/MM-Critic。

**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.09067) | [arXiv](https://arxiv.org/abs/2511.09067)



---

### 18. CC30k：面向可复现性情感分析的引文上下文数据集

**原文标题：** CC30k: A Citation Contexts Dataset for Reproducibility-Oriented Sentiment Analysis
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.07790) | [arXiv](https://arxiv.org/abs/2511.07790)
...
## 🎙️ 语音播报
- [收听今日论文解读](../audio/2025-11-14_daily_papers.mp3)
