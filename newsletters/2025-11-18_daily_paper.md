...
# <img src="https://huggingface.co/datasets/huggingface/brand-assets/resolve/main/hf-logo.png" width="30"/> Hugging Face 2025-11-18 论文日报

## 📊 今日论文统计
- 总论文数：28
- 热门领域：LLM, RL, GPT, Transformer

## 📝 论文详情


### 1. P1：基于强化学习的物理奥林匹克竞赛解题系统

**原文标题：** P1: Mastering Physics Olympiads with Reinforcement Learning
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.13612) | [arXiv](https://arxiv.org/abs/2511.13612)



---

### 2. MiroThinker：通过模型规模、上下文长度与交互深度的协同扩展突破开源研究智能体性能边界

**原文标题：** MiroThinker: Pushing the Performance Boundaries of Open-Source Research Agents via Model, Context, and Interactive Scaling
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.11793) | [arXiv](https://arxiv.org/abs/2511.11793)



---

### 3. Uni-MoE-2.0-Omni：基于先进混合专家系统、训练策略与数据技术的以语言为中心的全模态大模型扩展

**原文标题：** Uni-MoE-2.0-Omni: Scaling Language-Centric Omnimodal Large Model with Advanced MoE, Training and Data
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.12609) | [arXiv](https://arxiv.org/abs/2511.12609)



---

### 4. Souper-Model：简单算术如何实现前沿大语言模型性能突破

**原文标题：** Souper-Model: How Simple Arithmetic Unlocks State-of-the-Art LLM Performance
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.13254) | [arXiv](https://arxiv.org/abs/2511.13254)



---

### 5. Part-X-MLLM：面向部件感知的三维多模态大语言模型

**原文标题：** Part-X-MLLM: Part-aware 3D Multimodal Large Language Model
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.13647) | [arXiv](https://arxiv.org/abs/2511.13647)



---

### 6. MMaDA-并行：面向思维感知编辑与生成的多模态扩散大语言模型

**原文标题：** MMaDA-Parallel: Multimodal Large Diffusion Language Models for Thinking-Aware Editing and Generation
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.09611) | [arXiv](https://arxiv.org/abs/2511.09611)



---

### 7. GroupRank：一种强化学习驱动的分组重排序范式

**原文标题：** GroupRank: A Groupwise Reranking Paradigm Driven by Reinforcement Learning
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.11653) | [arXiv](https://arxiv.org/abs/2511.11653)



---

### 8. TiViBench：视频生成模型中的视觉推理能力基准测试框架

**原文标题：** TiViBench: Benchmarking Think-in-Video Reasoning for Video Generative Models
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.13704) | [arXiv](https://arxiv.org/abs/2511.13704)



---

### 9. PhysX-Anything：基于单图像的仿真就绪物理三维资产生成框架

**原文标题：** PhysX-Anything: Simulation-Ready Physical 3D Assets from Single Image
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.13648) | [arXiv](https://arxiv.org/abs/2511.13648)
...
**原文标题：** UFO^3: Weaving the Digital Agent Galaxy
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.11332) | [arXiv](https://arxiv.org/abs/2511.11332)



---

### 11. 进化方法而非提示：大语言模型越狱攻击的演化合成

**原文标题：** Evolve the Method, Not the Prompts: Evolutionary Synthesis of Jailbreak Attacks on LLMs
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.12710) | [arXiv](https://arxiv.org/abs/2511.12710)



---

### 12. 回归本源：让去噪生成模型真正执行去噪任务

**原文标题：** Back to Basics: Let Denoising Generative Models Denoise
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.13720) | [arXiv](https://arxiv.org/abs/2511.13720)



---

### 13. OlmoEarth：面向多模态地球观测的稳定隐空间图像建模

**原文标题：** OlmoEarth: Stable Latent Image Modeling for Multimodal Earth Observation
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.13655) | [arXiv](https://arxiv.org/abs/2511.13655)



---

### 14. Live-SWE-agent：软件工程智能体能否实现实时自主演进？

**原文标题：** Live-SWE-agent: Can Software Engineering Agents Self-Evolve on the Fly?
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.13646) | [arXiv](https://arxiv.org/abs/2511.13646)



---

### 15. 基因组下一标记预测器具备上下文学习能力

**原文标题：** Genomic Next-Token Predictors are In-Context Learners
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.12797) | [arXiv](https://arxiv.org/abs/2511.12797)



---

### 16. WebCoach：具备跨会话记忆引导的自演进网络智能体

**原文标题：** WebCoach: Self-Evolving Web Agents with Cross-Session Memory Guidance
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.12997) | [arXiv](https://arxiv.org/abs/2511.12997)



---

### 17. 评估大语言模型在知识图谱中的偶然性发现能力：以药物重定位为例

**原文标题：** Assessing LLMs for Serendipity Discovery in Knowledge Graphs: A Case for Drug Repurposing
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.12472) | [arXiv](https://arxiv.org/abs/2511.12472)



---

### 18. 面向视觉语言模型零样本泛化的测试时频谱感知隐空间调控

**原文标题：** Test-Time Spectrum-Aware Latent Steering for Zero-Shot Generalization in Vision-Language Models
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.09809) | [arXiv](https://arxiv.org/abs/2511.09809)



---

### 19. UnSAMv2：自监督学习实现任意粒度图像分割

**原文标题：** UnSAMv2: Self-Supervised Learning Enables Segment Anything at Any Granularity
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.13714) | [arXiv](https://arxiv.org/abs/2511.13714)



---

### 20. MicroVQA++：面向多模态大语言模型的高质量显微图像推理数据集与弱监督图结构

**原文标题：** MicroVQA++: High-Quality Microscopy Reasoning Dataset with Weakly Supervised Graphs for Multimodal Large Language Model
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.11407) | [arXiv](https://arxiv.org/abs/2511.11407)



---

### 21. 动态反思：通过文本对齐探究视频表征能力

**原文标题：** Dynamic Reflections: Probing Video Representations with Text Alignment
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.02767) | [arXiv](https://arxiv.org/abs/2511.02767)



---

### 22. LoCoBench-Agent：面向长上下文软件工程场景的大语言模型智能体交互式评测基准

**原文标题：** LoCoBench-Agent: An Interactive Benchmark for LLM Agents in Long-Context Software Engineering
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.13998) | [arXiv](https://arxiv.org/abs/2511.13998)



---

### 23. SafeGRPO：基于规则约束策略优化的自奖励多模态安全对齐方法

**原文标题：** SafeGRPO: Self-Rewarded Multimodal Safety Alignment via Rule-Governed Policy Optimization
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.12982) | [arXiv](https://arxiv.org/abs/2511.12982)



---

### 24. AI-Salesman：构建可信赖的大语言模型驱动电话营销系统

**原文标题：** AI-Salesman: Towards Reliable Large Language Model Driven Telemarketing
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.12133) | [arXiv](https://arxiv.org/abs/2511.12133)



---

### 25. Instella：具备卓越性能的完全开放语言模型

**原文标题：** Instella: Fully Open Language Models with Stellar Performance

**摘要：**
大语言模型已在广泛任务中展现出卓越性能，然而多数高性能模型仍保持闭源或部分开放，限制了研究的透明度与可复现性。本研究推出Instella系列——完全开放的三十亿参数语言模型，其训练全程基于公开可获取的数据与代码库。依托AMD Instinct MI300X GPU的算力支持，该模型通过大规模预训练、通用指令微调及人类偏好对齐三个阶段构建。尽管预训练词元数量显著少于同期多数模型，Instella在完全开放模型中取得了领先性能，并与同类规模的顶尖开放权重模型表现相当。我们同时发布两个专项优化版本：支持128K词元上下文长度的Instella-Long，以及通过监督微调与数学任务强化学习增强的推理专用模型Instella-Math。这些成果共同确立了Instella作为透明、高效、多功能的开源替代方案，有力推进了开放可复现语言模型研究的发展目标。

**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.10628) | [arXiv](https://arxiv.org/abs/2511.10628)



---

### 26. 基于区块链可信源可靠性的去中心化检索增强生成系统

**原文标题：** A Decentralized Retrieval Augmented Generation System with Source Reliabilities Secured on Blockchain
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.07577) | [arXiv](https://arxiv.org/abs/2511.07577)



---

### 27. NORA-1.5：基于世界模型与动作偏好奖励训练的视觉-语言-动作模型

**原文标题：** NORA-1.5: A Vision-Language-Action Model Trained using World Model- and Action-based Preference Rewards

**摘要：**
视觉-语言-动作模型近期在各类具身任务中展现出良好性能，但其可靠性与泛化能力仍存在不足，尤其在跨智能体部署或真实环境应用时更为明显。本研究提出NORA-1.5模型，该模型基于预训练的NORA主干网络，通过引入基于流匹配的动作专家模块实现架构升级。仅此结构改进即带来显著性能提升，使NORA-1.5在仿真与真实环境测试中均超越原始NORA模型及多项前沿VLA模型。为进一步增强鲁棒性与任务成功率，我们开发了一套用于后训练VLA策略的奖励模型。该奖励体系融合了：（i）动作条件世界模型——评估生成动作是否导向预期目标；（ii）真实动作偏差启发式规则——区分优质与劣质动作。利用这些奖励信号，我们构建偏好数据集并通过直接偏好优化方法使NORA-1.5适配目标智能体。大量实验表明，基于奖励的后训练能持续提升模型在仿真与真实机器人环境中的表现，通过简洁高效的奖励模型实现了VLA模型可靠性的显著进步。我们的研究成果印证了NORA-1.5模型与奖励引导后训练机制可作为开发适用于真实场景的可靠具身智能体的有效路径。

**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.14659) | [arXiv](https://arxiv.org/abs/2511.14659)



---

### 28. OpenUS：基于自适应掩码对比学习的全开源超声图像分析基础模型

**原文标题：** OpenUS: A Fully Open-Source Foundation Model for Ultrasound Image Analysis via Self-Adaptive Masked Contrastive Learning
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2511.11510) | [arXiv](https://arxiv.org/abs/2511.11510)
...
## 🎙️ 语音播报
- [收听今日论文解读](../audio/2025-11-18_daily_papers.mp3)
