...
# <img src="https://huggingface.co/datasets/huggingface/brand-assets/resolve/main/hf-logo.png" width="30"/> Hugging Face 2026-01-15 论文日报

## 📊 今日论文统计
- 总论文数：27
- 热门领域：GPT, LLM, RL, Transformer, NLP
...
**原文标题：** Controlled Self-Evolution for Algorithmic Code Optimization
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.07348) | [arXiv](https://arxiv.org/abs/2601.07348)



---

### 2. DeepResearchEval：一种用于深度研究任务构建与智能体评估的自动化框架

**原文标题：** DeepResearchEval: An Automated Framework for Deep Research Task Construction and Agentic Evaluation
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09688) | [arXiv](https://arxiv.org/abs/2601.09688)



---

### 3. MAXS：基于大语言模型智能体的元自适应探索框架

**原文标题：** MAXS: Meta-Adaptive Exploration with LLM Agents
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09259) | [arXiv](https://arxiv.org/abs/2601.09259)



---

### 4. A^3-Bench：基于锚点与吸引子激活的记忆驱动科学推理基准测试

**原文标题：** A^3-Bench: Benchmarking Memory-Driven Scientific Reasoning via Anchor and Attractor Activation
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09274) | [arXiv](https://arxiv.org/abs/2601.09274)



---

### 5. 分布对齐序列蒸馏：实现卓越的长链思维推理

**原文标题：** Distribution-Aligned Sequence Distillation for Superior Long-CoT Reasoning
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09088) | [arXiv](https://arxiv.org/abs/2601.09088)



---

### 6. Fast-ThinkAct：通过可言语化潜在规划实现高效视觉-语言-动作推理

**原文标题：** Fast-ThinkAct: Efficient Vision-Language-Action Reasoning via Verbalizable Latent Planning
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09708) | [arXiv](https://arxiv.org/abs/2601.09708)



---

### 7. SkinFlow：基于动态视觉编码与分阶段强化学习的开放性皮肤病诊断高效信息传输框架

**原文标题：** SkinFlow: Efficient Information Transmission for Open Dermatological Diagnosis via Dynamic Visual Encoding and Staged RL
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09136) | [arXiv](https://arxiv.org/abs/2601.09136)



---

### 8. OpenDecoder：开放大语言模型解码以在检索增强生成中融入文档质量评估

**原文标题：** OpenDecoder: Open Large Language Model Decoding to Incorporate Document Quality in RAG
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09028) | [arXiv](https://arxiv.org/abs/2601.09028)



---

### 9. OpenVoxel：面向开放词汇3D场景理解的免训练体素分组与描述方法

**原文标题：** OpenVoxel: Training-Free Grouping and Captioning Voxels for Open-Vocabulary 3D Scene Understanding
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09575) | [arXiv](https://arxiv.org/abs/2601.09575)



---

### 10. ExpSeek：面向网络智能体的自触发经验寻求机制

**原文标题：** ExpSeek: Self-Triggered Experience Seeking for Web Agents

**摘要：**
经验干预在网络智能体中作为一种前景广阔的技术范式，通过利用积累的经验提供有价值的洞察，从而增强智能体的交互能力。然而，现有方法主要在任务执行前将经验作为全局上下文被动注入，难以适应智能体与环境交互过程中动态变化的上下文观察。我们提出ExpSeek，将经验干预转向步骤级的主动寻求机制：（1）利用模型内在信号估计步骤级熵阈值以确定干预时机；（2）设计步骤级定制化的经验内容。在四个具有挑战性的网络智能体基准测试中，基于Qwen3-8B和32B模型的实验表明，ExpSeek分别实现了9.3%和7.5%的绝对性能提升。我们的实验验证了熵作为自触发信号的可行性及优势，并揭示即使仅使用4B规模的小型经验模型也能显著提升大型智能体模型的性能。

**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.08605) | [arXiv](https://arxiv.org/abs/2601.08605)



---

### 11. EvoFSM：基于有限状态机的可控自进化深度研究框架

**原文标题：** EvoFSM: Controllable Self-Evolution for Deep Research with Finite State Machines
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09465) | [arXiv](https://arxiv.org/abs/2601.09465)



---

### 12. FocusUI：基于位置保持视觉标记选择的高效用户界面定位方法

**原文标题：** FocusUI: Efficient UI Grounding via Position-Preserving Visual Token Selection
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.03928) | [arXiv](https://arxiv.org/abs/2601.03928)



---

### 13. 大语言模型是否易受偏好削弱攻击？一种诊断偏好对齐与现实有效性权衡的析因分析方法

**原文标题：** Are LLMs Vulnerable to Preference-Undermining Attacks (PUA)? A Factorial Analysis Methodology for Diagnosing the Trade-off between Preference Alignment and Real-World Validity
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.06596) | [arXiv](https://arxiv.org/abs/2601.06596)



---

### 14. TranslateGemma技术报告

**原文标题：** TranslateGemma Technical Report
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09012) | [arXiv](https://arxiv.org/abs/2601.09012)



---

### 15. 想象而后规划：基于世界模型的自适应前瞻智能体学习

**原文标题：** Imagine-then-Plan: Agent Learning from Adaptive Lookahead with World Models
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.08955) | [arXiv](https://arxiv.org/abs/2601.08955)



---

### 16. 基于稀疏扩散与三维渲染的静态场景高效相机控制视频生成

**原文标题：** Efficient Camera-Controlled Video Generation of Static Scenes via Sparse Diffusion and 3D Rendering
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09697) | [arXiv](https://arxiv.org/abs/2601.09697)
...
**原文标题：** Geometric Stability: The Missing Axis of Representations
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09173) | [arXiv](https://arxiv.org/abs/2601.09173)



---

### 18. 人工智能海马体：我们距离人类记忆还有多远？

**原文标题：** The AI Hippocampus: How Far are We From Human Memory?
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09113) | [arXiv](https://arxiv.org/abs/2601.09113)



---

### 19. 流等变世界模型：面向部分可观测动态环境的记忆机制

**原文标题：** Flow Equivariant World Models: Memory for Partially Observed Dynamic Environments
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.01075) | [arXiv](https://arxiv.org/abs/2601.01075)



---

### 20. DPWriter：基于多样化规划分支强化学习的创意写作方法

**原文标题：** DPWriter: Reinforcement Learning with Diverse Planning Branching for Creative Writing

**摘要：**
基于强化学习的大语言模型增强方法常导致输出多样性下降，削弱了其在创意写作等开放式任务中的实用性。现有方法缺乏引导多样化探索的显式机制，往往优先考虑优化效率与性能而忽视多样性。本文提出一种围绕半结构化长链思维构建的强化学习框架，该框架将生成过程分解为显式规划的中间步骤。我们引入一种多样化规划分支方法，该方法基于多样性变化在规划阶段策略性地引入分岔，并结合群体感知多样性奖励以激励差异化轨迹生成。在创意写作基准测试上的实验结果表明，该方法在保持生成质量的同时显著提升了输出多样性，各项指标持续优于现有基线模型。

**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09609) | [arXiv](https://arxiv.org/abs/2601.09609)



---

### 21. Omni-R1：迈向统一生成式多模态推理范式

**原文标题：** Omni-R1: Towards the Unified Generative Paradigm for Multimodal Reasoning
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09536) | [arXiv](https://arxiv.org/abs/2601.09536)



---

### 22. 告别陈旧反馈：面向开放世界智能体学习的协同演化批评器

**原文标题：** No More Stale Feedback: Co-Evolving Critics for Open-World Agent Learning
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.06794) | [arXiv](https://arxiv.org/abs/2601.06794)



---

### 23. SCALER：面向推理任务的合成式可扩展自适应学习环境

**原文标题：** SCALER:Synthetic Scalable Adaptive Learning Environment for Reasoning
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.04809) | [arXiv](https://arxiv.org/abs/2601.04809)



---

### 24. 焦点引导：从视频扩散模型的语义弱层中解锁可控性

**原文标题：** Focal Guidance: Unlocking Controllability from Semantic-Weak Layers in Video Diffusion Models
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.07287) | [arXiv](https://arxiv.org/abs/2601.07287)



---

### 25. 集群工作负载分配：基于自然语言处理的语义软亲和性

**原文标题：** Cluster Workload Allocation: Semantic Soft Affinity Using Natural Language Processing
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.09282) | [arXiv](https://arxiv.org/abs/2601.09282)



---

### 26. sui-1：基于引证且可验证的长文本摘要生成模型

**原文标题：** sui-1: Grounded and Verifiable Long-Form Summarization

**摘要：**
大型语言模型常生成看似合理但无法忠实反映原文的摘要，用户难以依据源文本进行验证，这在政府与法律分析等对合规性要求严格的领域构成关键局限。本文提出sui-1模型，该模型拥有240亿参数，能够生成包含文中引证的抽象摘要，使用户能够将每个主张追溯至源语句。我们通过结合思维链提示与多阶段验证的合成数据流程，从议会文件、网络文本及维基百科等多样化来源中，生成了涵盖五种语言超过22,000个高质量训练样本。评估表明，sui-1在各项指标上显著优于所有测试的开源基线模型，包括参数量为其三倍的模型。这些结果证明，针对引证型摘要任务的专业化训练能够显著超越单纯扩大模型规模的效果。模型权重及交互演示已公开发布。

**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.08472) | [arXiv](https://arxiv.org/abs/2601.08472)



---

### 27. SampoNLP：一种用于子词分词器形态学分析的自参照工具包

**原文标题：** SampoNLP: A Self-Referential Toolkit for Morphological Analysis of Subword Tokenizers
...
**论文链接：** [HuggingFace](https://huggingface.co/papers/2601.04469) | [arXiv](https://arxiv.org/abs/2601.04469)
...
## 🎙️ 语音播报
- [收听今日论文解读](../audio/2026-01-15_daily_papers.mp3)
